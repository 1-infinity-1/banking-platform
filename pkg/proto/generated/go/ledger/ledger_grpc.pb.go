...
func (c *ledgerServiceClient) GetStatement(ctx context.Context, in *GetStatementRequest, opts ...grpc.CallOption) (*Statement, error) {
...
func (UnimplementedLedgerServiceServer) GetStatement(context.Context, *GetStatementRequest) (*Statement, error) {
