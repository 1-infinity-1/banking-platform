...
func (r *Repository) CreateAccountTx(ctx context.Context, tx pgx.Tx, req models.CreateAccountRequest) (*models.Account, error) {
	// TODO: implement
...
func (r *Repository) UpdateStatusTx(ctx context.Context, tx pgx.Tx, req models.UpdateStatusRequest) (*models.Account, error) {
	// TODO: implement
	return nil, fmt.Errorf("UpdateStatusTx: %w", models.ErrInternal)
}

func (r *Repository) DebitTx(ctx context.Context, tx pgx.Tx, req models.DebitRequest) (*models.DebitResult, error) {
	// TODO: implement (use idempotency_key unique constraint)
	return nil, fmt.Errorf("DebitTx: %w", models.ErrInternal)
}

func (r *Repository) CreditTx(ctx context.Context, tx pgx.Tx, req models.CreditRequest) (*models.CreditResult, error) {
	// TODO: implement (use idempotency_key unique constraint)
