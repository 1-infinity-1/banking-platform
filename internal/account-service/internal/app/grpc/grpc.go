...
import (
	...
	accountgrpc "github.com/1-infinity-1/banking-platform/internal/account-service/internal/transport/grpc"
	internal_interceptor "github.com/1-infinity-1/banking-platform/internal/account-service/internal/transport/grpc/interceptor"
...
func NewApp(
	...
	port int,
	conn *postgres.Conn,
	svc accountgrpc.AccountService,
) *App {
	...
	accountgrpc.NewServerAPI(gRPCServer, svc)
