...
var operationRolesBearerAuth = map[string][]string{
	...
	GetStatementOperation:          []string{},
	GetTransactionOperation:        []string{},
	GetTransactionHistoryOperation: []string{},
	GetUserAccountsOperation:       []string{},
	ReplenishOperation:             []string{},
	TransferOperation:              []string{},
	UpdateAccountStatusOperation:   []string{},
}
