...
func (s *Server) decodeReplenishRequest(r *http.Request) (
...
func (s *Server) decodeTransferRequest(r *http.Request) (
	req *TransferRequest,
	rawBody []byte,
	close func() error,
	rerr error,
...
func (s *Server) decodeUpdateAccountStatusRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request UpdateAccountStatusRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
